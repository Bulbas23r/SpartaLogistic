...
public class RoleCheckAspect {
  ...
  public Object checkRole(ProceedingJoinPoint joinPoint, RoleCheck roleCheck) throws Throwable {
    ...
    if (headerRole == null || Arrays.stream(requiredRoles).noneMatch(role -> role.equals(headerRole))) {
      throw new ForbiddenException("권한이 없습니다. (필요한 역할: " + String.join(", ", requiredRoles) + ")");
    }
