...
public interface UserService {
    ...
    UserResponseForRegisterDto<UserDataForRegisterDto> patchUser(Long userId,
    ...
    Page<User> searchUser(Pageable pageable, Direction sortDirection, CommonSortBy sortBy,
        String keyword);
